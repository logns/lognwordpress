        	...
        	<div class="form-wrap">
            	<form id="update_pie_cssjs" class="validate" method="post">
                	...
                	<div class="form-field">
                    	<label for="parent" class="sr-only"><?php _e('Custom CSS','wpcssjs');?></label>
						...
						?></textarea>
                        <code>&lt;/style&gt;</code>
                        <p class="help-text"><?php _e("Please put custom css you want to put in head.",'wpcssjs');?></p>
                    </div>
                    <div class="form-field">
                    	<label for="parent" class="sr-only"><?php _e('Custom JS/Jquery','wpcssjs');?></label>
						...
						?></textarea>
                        <code>&lt;/script&gt;</code>
                        <p class="help-text"><?php _e("Please put custom javascript/jQuery you want to put in head.",'wpcssjs');?></p>
                    </div>
                	...
                	<div class="form-field">
						...
						?></textarea>
                        <code>&lt;/style&gt;</code>
                        <p class="help-text"><?php _e("Please put custom css you want to put in Footer.",'wpcssjs');?></p>
                    </div>
                    <div class="form-field">
                    	<label for="parent" class="sr-only"><?php _e('Custom JS/Jquery','wpcssjs');?></label>
                        <code>&lt;script type="text/javascript"&gt;</code>
						...
						?></textarea>
                        <code>&lt;/script&gt;</code>
                        <p class="help-text"><?php _e("Please put custom javascript/jQuery you want to put in Footer.",'wpcssjs');?></p>
                    </div>
                    <p class="submit">
