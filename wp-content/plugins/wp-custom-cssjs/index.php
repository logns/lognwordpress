...
class pieCsutomCJ{
	...
	function addPanel(){
		add_theme_page( __('Add/Edit Custom CSS, JS, Jquery or Tracking Pixel on the site',"wpcssjs"), __('Custom CSS/JS',"wpcssjs"), 'edit_theme_options', 'wp_custom_css_js', array($this, 'backendConf') );
	}
