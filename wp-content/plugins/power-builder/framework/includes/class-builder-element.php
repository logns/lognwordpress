		...
		switch( $field['type'] ) {
			...
			case 'custom_padding':
				...
				$field_el = sprintf(
					...
					$need_mobile_options ?
						sprintf(
							'<input type="hidden" name="%1$s_tablet" data-default="%4$s" id="%2$s_tablet" class="tm-pb-main-setting tm_custom_margin_main tm_pb_setting_mobile tm_pb_setting_mobile_tablet" data-device="tablet" %5$s %3$s %7$s/>
							<input type="hidden" name="%1$s_phone" data-default="%4$s" id="%2$s_phone" class="tm-pb-main-setting tm_custom_margin_main tm_pb_setting_mobile tm_pb_setting_mobile_phone" data-device="phone" %6$s %3$s %8$s/>',
							esc_attr( $field['name'] ),
							esc_attr( $field['id'] ),
							$attributes,
							esc_attr( $default ),
			...
			if ( 'on' === $button_custom ) {
				...
				if ( 'off' === $button_use_icon ) {
					...
					$hover_after_styles = sprintf(
						...
						%2$s
						%3$s',
						'' !== $button_icon_code ? sprintf( 'margin-left:%1$s;', '35' !== $button_icon_code ? '.3em' : '0' ) : '',
						'' !== $button_icon_code ?
